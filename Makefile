...
CXX_SUGGEST_OPT = -Wsuggest-attribute=const -Wsuggest-attribute=const
...
VALGMCFLAGS = --xtree-leak=yes --track-origins=yes --expensive-definedness-checks=yes
...
.PHONY: default test test_memcheck test_callgrind test_full clean
